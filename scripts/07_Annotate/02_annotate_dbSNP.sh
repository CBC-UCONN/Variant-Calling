...
# get the dbsnp set for chromosome 20
	...
	gatk UpdateVCFSequenceDictionary -V $OUTDIR/chr20.dbsnp.vcf.gz --source-dictionary ../../results/07_Annotate/fb_vap.ann.vcf.gz --output $OUTDIR/chr20.dbsnp.contig.vcf.gz --replace=true
