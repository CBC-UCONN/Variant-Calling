...
OUTDIR=../../results/03_AlignmentAndCoverage/long_read_coverage
mkdir -p $OUTDIR
...
bamtools filter -in - -mapQuality ">30" -isDuplicate false -isProperPair false | \
